...
var sizes={};
var fontname="";
var file=File.openDialog("Open file containg font mappings:");
file.open("r");
while(file.eof==false){
    fontname=file.readln();
    toFonts[fontname]=file.readln();
    sizes[fontname]=file.readln();
    alert(fontname + ": " + toFonts[fontname] + ", " + sizes[fontname]);
}
//Mappings loaded----------------------------------------------------------------------------------
// Progress bar -----------------------------------------------------------------------------------  
...
for (var i = 0; i < stories.length; i++) {
  ...
  for (var j = textStyleRanges.length-1; j >= 0; j--) {
    ...
    if (converted != undefined) {
      ...
      if(myText.appliedFont.fontFamily in sizes){
            myText.pointSize=myText.pointSize*sizes[myText.appliedFont.fontFamily];                 
            myText.appliedFont = app.fonts.item(toFonts[myText.appliedFont.fontFamily]);            
        }
